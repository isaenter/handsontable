...
module.exports = {
  sidebar: [
    { title: '入门', children: gettingStartedItems },
    { title: '样式', children: stylingItems },
    { title: '列', children: columnsItems },
    { title: '行', children: rowsItems },
    { title: '单元格特征', children: cellFeaturesItems },
    { title: '单元格函数', children: cellFunctionsItems },
    { title: '单元格类型', children: cellTypesItems },
    { title: '公式', children: formulasItems },
    { title: '导航', children: navigationItems },
    { title: '无障碍', children: accessibilityItems },
    { title: '配件和菜单', children: accessoriesAndMenusItems },
    { title: '国际化', children: internationalizationItems },
    { title: '与 Angular 集成', children: integrateWithAngularItems },
    { title: '与 Vue 2 集成', children: integrateWithVueItems },
    { title: '与 Vue 3 集成', children: integrateWithVue3Items },
    { title: '工具和打包', children: buildingAndToolingItems },
    { title: '优化', children: optimizationItems },
    { title: '安全', children: securityItems },
    { title: '技术规格', children: technicalSpecificationItems },
    { title: '升级和迁移', children: upgradeAndMigrationItems }
  ],
};
